                ...
                _react2.default.createElement(
                    ...
                    function (_ref) {
                        ...
                        return _react2.default.createElement(
                            ...
                            {
                                defaultStyle: ds,
                                style: (0, _utils.springlization)({ scale: cs.scale }, 0.025),
                                onRest: _this2.handleMotionRest
                            },
                            function (_ref2) {
...
Images.getBrowsingStyle = function (props, imageRef) {
    ...
    return {
        ...
        y: 0,
        opacity: 1,
        scale: (0, _utils.calcFitScale)(naturalWidth, naturalHeight, margin, Math.abs(rotate) % 180 > 0 ? true : false),
        rotate: rotate,
        borderRadius: 10
    };
};
...
Images.getZoomingStyle = function () {
    var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref3$clientX = _ref3.clientX,
        mouseX = _ref3$clientX === undefined ? (0, _utils.scrollWidth)() / 2 : _ref3$clientX,
        _ref3$clientY = _ref3.clientY,
        mouseY = _ref3$clientY === undefined ? (0, _utils.windowHeight)() / 2 : _ref3$clientY;
...
var defProp = exports.defProp = {
	...
	getSpringOption: function getSpringOption(precision) {
		return { stiffness: 230, damping: 25, precision: precision };
	}
...
var calcFitScale = exports.calcFitScale = function calcFitScale(naturalWidth, naturalHeight, margin) {
    var useMax = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    if (!useMax) {
        ...
        var _scaleX = clientHeight() / (naturalWidth + 2 * margin);
        var _scaleY = clientWidth() / (naturalHeight + 2 * margin);
        return Math.min(_scaleX, _scaleY);
    }
};
...
var springlization = exports.springlization = function springlization(attr) {
    var precision = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.01;

    var res = {};
    for (var i in attr) {
        res[i] = (0, _reactMotion.spring)(attr[i], _default.defProp.getSpringOption(precision));
    }
    return res;
};
